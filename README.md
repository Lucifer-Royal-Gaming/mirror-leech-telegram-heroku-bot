...
## By [Lucifer Royal Gaming](https://github.com/Lucifer-Royal-Gaming)
- qBittorrent
...
- `SEARCH_LIMIT`: Search limit for search api, limit for each site and not overall result limit. Default is 10.
